...
/**
 * 재현이 안 되는 원격 리포트(무선 adb 연결 실패 등)를 진단하기 위한 경량 이벤트 로거.
 *
...
object DiagnosticLog {
    ...
    /**
     * 추가 진단 정보 확장 지점 — 디버그 빌드는 이미 쥐고 있는 adb 셸 연결로 실제 logcat 을
     * 떠서 여기 꽂는다 (`TrackerApplication.onCreate()` 에서 등록). 릴리스 빌드는 등록 자체를
     * 안 해서 항상 null 이다.
     */
